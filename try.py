...
for random_reservation_amount in range(random.randint(3, 8)):
    ...
    if days_selected:
        ...
        if stamp_check_1 or stamp_check_2 or stamp_check_3 or stamp_check_4:
            ...
            Alr_reserved = False
    room_list[random_reservation_amount] = Reservations(room_count, rand_type,arr_timestamp,dep_timestamp,Alr_reserved)
    print(room_list[random_reservation_amount].room_num)
